...
CREATE TABLE travel (
   ...
   FOREIGN KEY (bus_number) REFERENCES busdetail(bus_number)
) AUTO_INCREMENT = 0;
drop table travel;
select * from travel;
drop table travel;
truncate table travel;
INSERT INTO travel (source, destination, fare, duration, departure, arrival, bus_number, date_of_travel) VALUES
('Kathmandu', 'Biratnagar', 1600, '3 hour', '05:00', '07:00', '1313', '25522-07-14');
INSERT INTO travel (source, destination, fare, duration, departure, arrival, bus_number, date_of_travel) VALUES
('Kathmandu', 'Biratnagar', 1600, '3 hour', '05:00', '07:00', '124', '25522-07-14');
